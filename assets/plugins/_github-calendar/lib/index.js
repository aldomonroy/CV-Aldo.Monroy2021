 ...
 *      The default is using [aldomonroy](https://github.com/aldomonroy)'s [`urlreq`](https://aldomonroy.github.io/urlreq/).
...
module.exports = function GitHubCalendar (container, username, options) {
    ...
    // Thanks, @aldomonroy (https://aldomonroy.github.io/urlreq/)
